      ...
      $(document).on('click', '.ot_upload_media', function() {
        ...
        if ( window.wp && wp.media ) {
          ...
          window.ot_media_frame.on('select', function() {
            ...
            btnContent += '<a href="javascript:(void);" class="option-tree-ui-remove-media option-tree-ui-button button button-secondary light" title="'+option_tree.remove_media_text+'"><span class="icon trash-can">'+option_tree.remove_media_text+'</span></a>';
            $('#'+field_id).val(href);
