...
add_filter( \'ot_radio_images\', \'filter_radio_images\', 10, 2 );</code></pre>';
        ...
        echo '<p>' . sprintf( __( 'The Social Links option type utilizes a drag & drop interface to create a list of social links. There are a few filters that make extending this option type easy. You can use the %s filter to turn off loading default values, which is set to %s, by setting this to %s. To filter the default values that are loaded use the %s filter. To filter the settings array use the %s filter.', 'option-tree' ), '<code>ot_type_social_links_load_defaults</code>', '<code>true</code>', '<code>false</code>', '<code>ot_type_social_links_defaults</code>', '<code>ot_social_links_settings</code>' ) . '</p>';
