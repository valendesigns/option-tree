      ...
      echo '<div class="format-setting type-textblock has-desc">';
        ...
        echo '<div class="format-setting-inner">';
          ...
          echo '<div class="option-tree-ui-upload-parent">';
            ...
            /* add xml button */
            echo '<a href="javascript:void(0);" class="ot_upload_media option-tree-ui-button button button-primary light" rel="' . $post_id . '" title="' . __( 'Add XML', 'option-tree' ) . '"><span class="icon upload">' . __( 'Add XML', 'option-tree' ) . '</span></a>';
